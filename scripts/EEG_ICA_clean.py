...
# proc.find_eeg_files(dyad_ids=['W_018'])
...
proc.classify_and_save_labels(ica_folder, iclabel_threshold=0.70, brain_threshold=0.5, amplitude_threshold=100.0, timecourse_seconds=200.0)
