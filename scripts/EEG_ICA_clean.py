...
proc.find_eeg_files(dyad_ids='W_001')
...
proc.classify_and_save_labels(ica_folder, iclabel_threshold=0.70, timecourse_seconds=200.0)
# → otwórz CSV, sprawdź, zapisz
# cleaned_folder = ica_folder / 'CLEANED'
